...
const MeetingPage: React.FC = () => {
  const [activeOption, setActiveOption] = useState<string>('notes');
  ...
  const sampleVideoUrl: string = 'https://www.sample-videos.com/video123/mp4/720/big_buck_bunny_720p_1mb.mp4';
